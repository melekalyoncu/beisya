...
export default function Footer() {
  ...
  return (
    <footer className="bg-[var(--color-mauve)] text-white/70 overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-6 pt-16 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_2fr] gap-10 pb-12 border-b border-white/15">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div>
              <h4 className="text-[0.7rem] font-bold tracking-[0.14em] uppercase text-white/90 mb-4">
                {t("footer_nav")}
              </h4>
              {[
                { href: "/", key: "nav_home" },
                ...
                <Link
                  key={item.key}
                  href={item.href}
                  className="block text-sm text-white/50 mb-2.5 hover:text-white transition-colors"
                >
                  {t(item.key)}
                </Link>
              ))}
            ...
            <div>
              ...
              <p className="text-sm text-white/50 mb-2.5">Karşıyaka, İzmir</p>
              <p className="text-sm text-white/50">{t("contact_cargo_val")}</p>
            </div>
          </div>
        </div>
